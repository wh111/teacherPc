            ...
            <el-col>
                ...
                <el-form-item label="公用候选项：">
                    <el-col v-for="(item, index) in formValidate.questionsOptions" :key="index">
                        <el-form-item labelWidth="30px" :label="index | getCharCode">
                            ...
                            <el-col align="right" class="editTodoBtnBox" v-if="!lockQuestionsOptions">
                                <el-button class="whiteButton" @click="changeEdit('questionsOptions_'+index+'_content')">{{
                                    edits['questionsOptions_'+index+'_content'] ? '文本' : '图文' }}编辑
                                </el-button>
                                <!--<el-button class="greenButton" type="primary" @click="addquestionsOptions"-->
                                           <!--icon="el-icon-circle-plus"></el-button>-->
                                <!--<el-button class="orangeYellow" :disabled="formValidate.questionsOptions.length<2"-->
                    ...
                    <el-col class="editTodoBtnBox" align="right">
                        <el-button  class="whiteButton" :disabled="lockQuestionsOptions" @click="localSaveQuestionsOptions">保存候选项</el-button>
...
<script>
  ...
  import { question, questionsOptionsItem } from './dataTemp' // 数据模版
