                ...
                <div class="safeAccount" v-if="passwordTochange==1">
                    ...
                    <div class="p">
                      ...
                      v-if="ruleForm.wechat==1">已绑定</span>
                        <button class="change relative orangeYellow" v-if="ruleForm.wechat==0"
                                @click="linkWechat">绑定
                        </button>
                    </div>
                    <!--<div class="p pBottom">-->
                        ...
                        <!--<span v-if="ruleForm.qq">{{ruleForm.qq}}</span>-->
                        <!--<span v-if="!ruleForm.qq">未绑定</span>-->
                        <!--<button class="change relative" v-if="!ruleForm.qq" @click="linkqq">绑定</button>-->
