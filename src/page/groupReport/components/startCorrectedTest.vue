                                    ...
                                    <span>难度：{{itemChild.diffLevel}}</span><span>满分：{{itemChild.score}}</span><span
                                        ...
                                        class="el-icon-edit"></i>
                                         <div class="buttonContent" v-show="show&&itemChild.show" @click.stop="cancelHref">
                                          <el-input class="input" v-model="item.inputStudentScore"></el-input>
                                             <!--Child.studentScore-->
  ...
  export default {
    ...
    methods: {
        ...
        this.ajax({
          ajaxSuccess: (res) => {
            ...
            this.viewData.questionsList.map((item,index) => {
              ...
              item.inputStudentScore = item.studentScore || 0;
            })
          },
          ajaxParams: {
      ...
      correct (val, index,type,childrenIndex) {
        val.studentScore = val.inputStudentScore;
        this.questionData.questionsId = val.id
        this.questionData.score = val.studentScore || 0;
