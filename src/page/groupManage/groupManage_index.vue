        ...
        <div class="groupManage-top">
            ...
            更多<i class="el-icon-arrow-down el-icon--right"></i>
                ...
                <el-dropdown-menu slot="dropdown">
                    ...
                    <el-dropdown-item :disabled="!selectGroup||!groupList.length||!groupMessage.length" @click.native="makeHomework('selectGroup')">布置作业
                    </el-dropdown-item>
                    <el-dropdown-item @click.native="beginMatch" :disabled="!selectGroup||!groupList.length||!groupMessage.length">发布测评</el-dropdown-item>
                </el-dropdown-menu>
            </el-dropdown>
        </div>
        <div class="groupManage-top">
            ...
            更多<i class="el-icon-arrow-down el-icon--right"></i>
                ...
                <el-dropdown-menu slot="dropdown">
                    ...
                    <el-dropdown-item :disabled="!activeName||!groupListofSmallList||!groupMessage.length" @click.native="makeHomework('activeName')">布置作业
                    </el-dropdown-item>
                    <el-dropdown-item @click.native="beginMatch" :disabled="!activeName||!groupListofSmallList||!groupMessage.length">发布测评</el-dropdown-item>
                </el-dropdown-menu>
            </el-dropdown>
        </div>
