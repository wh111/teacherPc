...
config.ajaxBaseURL = {
    PUBLIC: "", // 公共接口
    STUDENT: "/api/stu",//学生端
    TEACHER: "/api/teacher",//教师端
    MANAGER: "/api/manager",//平台端
    GUARDIAN: "/api/guardian"  //家长端
}

config.ajaxconfig = {
    // 基础url前缀
  baseURL: config.ajaxBaseURL.TEACHER,
