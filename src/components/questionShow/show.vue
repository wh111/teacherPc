...
<template>
    <div>
        ...
        <template v-if="showDatas.groups">
            <mix-show v-if="showDatas.publics" :question="showDatas" :index="index" :hasDo="hasDo" :answerDo="answerDo"
            ...
            <group-show v-else :question="showDatas" :index="index" :hasDo="hasDo" :answerDo="answerDo"
                        :showAnswer="showAnswer" :showInput="showInput" @answer="answer">
                <slot name="todoBox" slot="todo"></slot>
                <slot name="title" slot="title"></slot>
                <template v-if="showDatas.groups && showDatas.childQuestionsList">
                    ...
                    <slot v-for="item in showDatas.childQuestionsList" :name="'answerRight'+item.id"
                          :slot="'answerRight'+item.id">
                    </slot>
                    <!--<template v-for="item in showDatas.childQuestionsList">-->
                        <!--<slot :name="'answerRight'+item.id"-->
                              <!--:slot="'answerRight'+item.id">-->
                        <!--</slot>-->
                    <!--</template>-->
        ...
        <template v-else>
            <radio-show v-if="showDatas.basicType === 'Radio'" :question="showDatas" :index="index" :hasDo="hasDo"
                        :showAnswer="showAnswer" :showInput="showInput" :answerDo="answerDo" @answer="answer">
                <slot name="todoBox" slot="todo"></slot>
                <slot name="title" slot="title"></slot>
                <slot name="answerRight" slot="answerRight"></slot>
            </radio-show>
            <checkbox-show v-if="showDatas.basicType === 'Checkbox'" :question="showDatas" :index="index"
                           :hasDo="hasDo" :answerDo="answerDo" :showAnswer="showAnswer" :showInput="showInput"
                           @answer="answer">
                <slot name="todoBox" slot="todo"></slot>
                <slot name="title"  slot="title"> </slot>
                <slot name="answerRight" slot="answerRight"></slot>
            ...
            <input-show v-if="showDatas.basicType === 'Input'" :question="showDatas" :index="index" :hasDo="hasDo"
                        :showAnswer="showAnswer" :answerDo="answerDo" :showInput="showInput" @answer="answer">
                <slot name="todoBox" slot="todo"></slot>
                <slot name="title"  slot="title"></slot>
                <slot name="answerRight" slot="answerRight"></slot>
            </input-show>
